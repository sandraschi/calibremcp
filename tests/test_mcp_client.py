...
class TestMCPClientConnection:
    ...
    async def setup(self):
        ...
        self.mock_http_client.get.return_value = self._mock_response(200, {
            "result": "pong"
        })
    ...
    async def test_call_tool(self):
        ...
        self.mock_http_client.post.return_value = self._mock_response(200, {
            "result": mock_result
        })
    ...
    async def test_error_handling(self):
        ...
        self.mock_http_client.get.return_value = self._mock_response(500, {
