...
class ExportLibraryTool(MCPTool):
    ...
    parameters = [
        ...
        Param("book_ids", Optional[List[Union[int, str]]], "Specific book IDs to export (all if None)", default=None),
    ...
    async def _run(self, export_path: str, library_path: Optional[str] = None, 
                  include_books: bool = True, include_metadata: bool = True,
                  include_covers: bool = True, book_ids: Optional[List[Union[int, str]]] = None,
                  format: str = "directory", progress_callback: Optional[str] = None) -> Dict:
    ...
    def _update_progress(self, callback_url: Optional[str], current: int, total: int, message: str) -> None:
