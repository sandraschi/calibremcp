...
from sqlalchemy import (
    ...
    ForeignKey, Table, UniqueConstraint, Index, event, DDL
)
...
class Data(Base):
    ...
    __table_args__ = (
        UniqueConstraint('book', 'format', name='data_book_format_uc'),
    )
...
class Identifier(Base):
    ...
    __table_args__ = (
        UniqueConstraint('book', 'type', name='identifiers_book_type_uc'),
    )
