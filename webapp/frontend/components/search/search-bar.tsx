...
export function SearchBar({
	...
	return (
		<form
			...
			className="bg-slate-800 border border-slate-600 p-4 rounded-lg mb-6"
		>
			...
			<div className="mt-3 flex flex-wrap items-center gap-4">
				...
				<span className="text-slate-500 text-xs">
					Requires Calibre FTS index (full-text-search.db). When on, only the
					search text box is used.
				</span>
			</div>
