...
import { type LogsResponse, getLogs, getSystemStatus } from "@/common/api";
		...
		<div className="container mx-auto p-6">
			...
			{error && (
				<div className="rounded-lg border border-amber-500/50 bg-amber-500/10 p-4 mb-4 text-slate-200">
					...
					{logs?.file && (
						<p className="text-xs text-slate-500 mt-1">Log file: {logs.file}</p>
					)}
				</div>
			)}
