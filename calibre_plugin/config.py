...
prefs.defaults["mcp_http_url"] = "http://127.0.0.1:10720"  # calibre-mcp webapp backend
prefs.defaults["ollama_url"] = "http://127.0.0.1:11434"    # local Ollama instance
prefs.defaults["ollama_model"] = "gemma3:12b"               # model for research synthesis
