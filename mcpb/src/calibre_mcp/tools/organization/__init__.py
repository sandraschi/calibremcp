    ...
    parameters={
        ...
        "plan": {
            ...
            "properties": {
                ...
                "rules": {"type": "array", "items": {"type": "object"}, "description": "List of organization rules"},
...
@tool(
    ...
    parameters={
        "library_path": {"type": "string", "description": "Path to the Calibre library"},
        "pattern": {"type": "string", "description": "Glob pattern to match files (e.g., '*.epub', '**/*.pdf')"},
        "target_dir": {"type": "string", "description": "Base directory to move files to"},
        "create_subdirs": {"type": "boolean", "default": True, "description": "Whether to create subdirectories based on metadata"},
        "dry_run": {"type": "boolean", "default": True, "description": "If True, only show what would be done"}
    }
)
...
@tool(
    ...
    parameters={
        "library_path": {"type": "string", "description": "Path to the Calibre library"},
        "book_ids": {"type": "array", "items": {"type": "string"}, "description": "List of book IDs to process (all books if None)"},
        "merge_similar": {"type": "boolean", "default": True, "description": "Whether to merge similar tags"},
        "min_length": {"type": "integer", "default": 2, "description": "Minimum tag length (shorter tags will be removed)"},
        "max_length": {"type": "integer", "default": 50, "description": "Maximum tag length (longer tags will be truncated)"},
        "remove_empty": {"type": "boolean", "default": True, "description": "Whether to remove empty tags"},
        "dry_run": {"type": "boolean", "default": True, "description": "If True, only show what would be changed"}
    }
)
...
@tool(
    name="get_organization_plans",
    description="Get all saved organization plans",
    parameters={}
)
...
@tool(
    ...
    parameters={
        "name": {"type": "string", "description": "Name of the plan to retrieve"}
    }
)
