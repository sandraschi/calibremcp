...
@tool(
    ...
    parameters={
        ...
        "update_metadata": {"type": "boolean", "description": "Whether to update book metadata with series information"}
    }
)
...
async def merge_series(library_path: str, source_series: str, target_series: str, dry_run: bool = True) -> Dict:
